		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav pull-right">
				<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" id="dropdownMenu">Welcome
					<%
						String login_msg = (String) request.getAttribute("usernameTemp");
						if (login_msg != null) {
							out.println("<font size=3px font family:times serif>" + login_msg + "</font>");
						}
					%>
				<span class="caret"></span></a>
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="/Login/ServletLogout.java"><i class="glyphicon glyphicon-off"></i> Logout</a></li>
					</ul>
				</li>
			</ul>
		</div>
			...
			<div class="col-sm-6">
				<div class="imageupload panel panel-default">
					...
					<div class="file-tab panel-body">
						<div class="uploader">
							<img src="" /> <input type="file" name="userprofile_picture" id="filePhoto" />
						</div>
						<label class="btn btn-primary btn-file" onclick="$('#filePhoto').click()"><span>Browse</span></label>
